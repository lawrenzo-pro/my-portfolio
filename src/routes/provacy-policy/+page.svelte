...
<svelte:head>
	<title>Lawrence Kimani - Privacy policy</title>
</svelte:head>
		...
		<ul>
			...
			<li>
				<p>
					...
					or &quot;Our&quot; in this Agreement) refers to Lawrence Kimani.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Lawrence Kimani, accessible from
					<a href="lauriesayske.web.app" rel="external nofollow noopener" target="_blank">Laurie Says</a>
				</p>
			</li>
			<li>
				<p>
